...
@interface uberinputObject : KrollCoverageObject {
#else
@interface uberinputObject : KrollObject {
#endif
@private
...
extern NSString * uberinput$ModuleRequireFormat;
