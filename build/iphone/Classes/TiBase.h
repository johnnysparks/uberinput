...
// in simulator we redefine to format for uberinput Developer console
...
{\
	NSString * exceptionName = [@"org.uberinput." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uberinput";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIuberinputNativeItemNone = -1, 
	UIuberinputNativeItemSpinner = -2,
	UIuberinputNativeItemProgressBar = -3,
	
	UIuberinputNativeItemSlider = -4,
	UIuberinputNativeItemSwitch = -5,
	UIuberinputNativeItemMultiButton = -6,
	UIuberinputNativeItemSegmented = -7,
	
	UIuberinputNativeItemTextView = -8,
	UIuberinputNativeItemTextField = -9,
	UIuberinputNativeItemSearchBar = -10,
	
	UIuberinputNativeItemPicker = -11,
	UIuberinputNativeItemDatePicker = -12,
	
	UIuberinputNativeItemInfoLight = -13,
	UIuberinputNativeItemInfoDark = -14,
	
	UIuberinputNativeItemDisclosure = -15,
	
	UIuberinputNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all uberinput instances of
