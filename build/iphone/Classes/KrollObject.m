 ...
 * Copyright (c) 2009-2011 by uberinput, Inc. All Rights Reserved.
...
//@interface uberinputObject : NSObject
//@end

@interface uberinputObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[uberinputObject class]])
		{
			for (NSString *key in [[(uberinputObject*)o modules] allKeys])
			{
